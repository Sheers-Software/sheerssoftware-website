...
import { Globe, Zap, Clock, Shield, ArrowRight, CheckCircle, MessageCircle } from 'lucide-react';
    ...
    return (
        <div style={{ padding: 'var(--space-2xl) 0' }}>
            ...
            <section style={{ padding: 'var(--space-xl) var(--space-lg)', textAlign: 'center' }}>
                ...
                <Link href="/solutions" style={{ color: 'var(--neon-cyan)', textDecoration: 'none', fontWeight: 'bold', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
