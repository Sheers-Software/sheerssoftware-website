                ...
                <div className="blog-grid">
                    {articles.map((article, index) => (
                        <motion.div
                            ...
                            style={{ display: 'flex' }}
                        >
                            <Link href={article.path} style={{ textDecoration: 'none', display: 'flex', width: '100%' }}>
                                <GlassCard variant="cyan" hover style={{ padding: 0, overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column', width: '100%' }}>
                                    <div className="blog-thumbnail" style={{ height: '220px', width: '100%', overflow: 'hidden', position: 'relative' }}>
                                        <img
