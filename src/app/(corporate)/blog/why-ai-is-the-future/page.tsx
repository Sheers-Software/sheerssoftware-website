...
import { BookOpen, Calendar, Clock, Phone, TrendingUp, AlertTriangle, ArrowRight } from 'lucide-react';
    ...
    return (
        <section className="section article-section" style={{ padding: '6rem 0' }}>
            <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                {/* Header */}
                <Link href="/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'var(--neon-cyan)', textDecoration: 'none', marginBottom: '2rem', fontWeight: 'bold' }}>
                ...
                >
                    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginBottom: '1.5rem', color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                        <span style={{ background: 'rgba(0, 255, 255, 0.1)', color: 'var(--neon-cyan)', padding: '4px 12px', borderRadius: '20px', fontWeight: 'bold' }}>Hospitality Tech</span>
                ...
                <div className="article-body" style={{ color: 'white', fontSize: '1.15rem', lineHeight: 1.8 }}>
                    ...
                    <GlassCard variant="magenta" style={{ padding: '2rem', marginBottom: '3rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                            <AlertTriangle size={28} className="text-neon-magenta" />
