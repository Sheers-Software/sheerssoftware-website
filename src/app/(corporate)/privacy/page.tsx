            ...
            <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div className="article-body" style={{ color: 'var(--text-primary)', fontSize: '1.1rem', lineHeight: 1.8 }}>
                    ...
                    <p style={{ marginBottom: '1.5rem' }}>
                        We collect personal data that you provide to us directly, such as your name, email address, phone number, and organization details when you fill out forms or contact us.
                    </p>
