...
import { LifeBuoy, Mail, FileText, CheckCircle } from 'lucide-react';
            ...
            <div className="container">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'var(--space-2xl)', marginTop: 'var(--space-2xl)' }}>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        <GlassCard variant="magenta" hover style={{ padding: 'var(--space-xl)', textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
                        <GlassCard variant="cyan" hover style={{ padding: 'var(--space-xl)', textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column' }}>
                            <div style={{ flexGrow: 1 }}>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
                        <GlassCard variant="green" hover style={{ padding: 'var(--space-xl)', textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column' }}>
                            <div style={{ flexGrow: 1 }}>
