...
const FAQ = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Yes! We offer comprehensive maintenance and support packages to ensure your digital products remain secure, up-to-date, and performant. Our support team is available via email and WhatsApp."
        },
        {
