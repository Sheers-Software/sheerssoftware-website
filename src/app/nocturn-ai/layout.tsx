...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://sheerssoft.com/nocturn-ai"),
  openGraph: {
    type: "website",
    locale: "en_MY",
    url: "https://sheerssoft.com/nocturn-ai",
...
export default function NocturnRootLayout({
  children,
}: Readonly<{
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <a href="/nocturn-ai/how-it-works" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>How It Works</a>
            <a href="/nocturn-ai/pilot" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>Founding Cohort</a>
            <a href="/nocturn-ai/blog" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>Insight Hub</a>
            <a href="/nocturn-ai/apply" style={{ color: 'var(--color-green)', textDecoration: 'none', fontWeight: 600 }}>Apply Now →</a>
          </div>

          <div className="footer-col" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <h4 style={{ color: 'white', fontSize: '0.9rem', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Company</h4>
            <a href="/nocturn-ai/about" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>Our Story</a>
            <a href="/nocturn-ai/about#team" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>Mission</a>
          ...
          <div className="footer-col" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <a href="/nocturn-ai/privacy" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>Privacy Policy</a>
            <a href="/nocturn-ai/terms" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>Terms of Service</a>
...
function MobileCTA() {
  return (
    <div className="mobile-cta hide-desktop">
      <a href="/nocturn-ai/apply" className="btn btn-primary" style={{ width: "100%", borderRadius: 0 }}>
