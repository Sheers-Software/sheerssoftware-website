...
export default function HomePage() {
  return (
    <div className="nocturn-v2">
      {/* --- SEGMENT 1: KILLER TRUST (Hero & Problem / ICP) --- */}
      <Hero />
      <UseCases />
      <InquiryGraveyard />

      {/* --- SEGMENT 2: PRODUCT (Headline, USPs, Demo) --- */}
      <ProductIntro />
      <BenefitGrid />
      <MidnightTest />
      <GMReportMockup />

      {/* --- SEGMENT 3: TRUST (Guarantees, Audits, Comparison, Founder, FAQ) --- */}
      <ComparisonSection />
      <AuditSection />
      <FounderSection />
      <FAQSection />

      {/* --- SEGMENT 4: OFFER (Headline, Price, CTA) --- */}
      <FoundingCohortOffer />
      <FinalCTASection />
    </div>
  );
...
function ProductIntro() {
  return (
    <section className="section section-gray" style={{ paddingBottom: '20px' }}>
      <div className="container" style={{ textAlign: 'center' }}>
        <span className="eyebrow">THE NOCTURN AI HYBRID CO-PILOT</span>
        <h2 style={{ marginBottom: 16 }}>Your 24/7 AI Revenue Recovery Layer</h2>
        <p style={{ fontSize: '1.2rem', color: 'var(--color-gray-500)', maxWidth: 700, margin: '0 auto' }}>
          Capture and convert manual inquiries into direct bookings automatically.
        </p>
      </div>
    </section>
  );
      ...
      <div className="container hero-inner">
        <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
          <motion.div variants={itemVariants} className="hero-subtitle-hyros">
            ...
            <h1 className="hero-subtitle-main" style={{ marginTop: 16 }}>Stop Losing Your Own Guests<br />to OTAs at 3 AM.</h1>
            <p className="hero-subtitle-sub">Nocturn AI turns WhatsApp and email inquiries into direct bookings — 24/7, in BM and English — while cutting staff overtime and proving every Ringgit recovered. Stop bleeding 15-30% in commissions today.</p>
          </motion.div>

          <motion.div variants={itemVariants} className="hero-ctas">
            <a href="/nocturn-ai/audit" className="btn btn-solid-white btn-lg" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <a href="/nocturn-ai/apply" className="btn btn-outline-white btn-lg">Start 48-Hour Implementation</a>
          </motion.div>
    ...
    <section className="section section-gray" id="offer">
      <div className="container">
        ...
        <div style={{ textAlign: 'center' }}>
          <a href="/nocturn-ai/apply" className="btn btn-solid-green btn-lg" style={{ fontSize: '1.1rem', padding: '20px 48px' }}>
      ...
      <div className="container">
        ...
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          >
            ...
            <a href="/nocturn-ai/apply" className="btn btn-solid-white btn-lg" style={{ marginTop: 24, display: 'inline-flex' }}>
