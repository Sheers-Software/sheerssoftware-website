...
const UseCases = () => {
    const [activeTab, setActiveTab] = useState<'reservation' | 'revenue' | 'gm'>('reservation');

    const cases: Record<'reservation' | 'revenue' | 'gm', UseCase> = {
        reservation: {
            id: 'reservation',
            ...
            <div className="container">
                ...
                <div className="use-cases-wrapper">
                    ...
                    <div className="use-case-tabs">
                        {(Object.values(cases) as UseCase[]).map((c) => (
                            <button
                                key={c.id}
